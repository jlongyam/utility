...
var ui = (function (exports) {
	...
	class Model {
		 ...
		 * @param  {Object} data    The data object
		 * @param  {Object} actions The model functions
		 * @param  {String} name    The custom event namespace for the sync
		 */
	 ...
	 * Create a new model
	 * @param  {Object} data    The data object
	 * @param  {Object} setters The model functions
	 * @param  {String} name    The custom event namespace for the sync
	 * @return {Proxy}          The Model instance
	 */
	...
	function diff (template, existing, events) {
		...
		templateNodes.forEach(function (node, index) {
			...
			// Stop diffing if a native web display
	 ...
	 * @param {Class} instance The Display instance
	 */
	...
	class Display {
		 ...
		 * @param  {Array}       options.syncs The names of the syncs to listen for
